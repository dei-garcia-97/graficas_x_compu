...
public class Main extends SimpleApplication {
    ...
    public void simpleUpdate(float tpf) {
        ...
        **/
        ...
        /**Dicho nodo gira en el eje "y"**/
        rootNode.getChild("nodo_pivote").rotate(0,tpf/3, 0);
        
        /**rootNode.getChild("nodo_marte").rotate(0,tpf, 0);**/ /** De la práctica anterior esta línea de código no iba**/
        /**Dicho nodo gira en el eje "x"**/
        rootNode.getChild("nodo_pivote1").rotate(tpf*1.5f,0,0); /** Velocidad en la que se va a desplazar**/
        /**rootNode.getChild("nodo_jupiter").rotate(0,tpf, 0);**/ /**De la práctica anterior esta línea de código no iba**/
        /**Dicho nodo gira en el eje "z"**/
        rootNode.getChild("nodo_pivote2").rotate(0,0,tpf/2); /** Velocidad en la que se va a desplazar**/
